...
@RestController
@RequestMapping("/api/jhipster-sample-application-mongo-kafka")
public class JhipsterSampleApplicationMongoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationMongoKafkaResource.class);
    ...
    public JhipsterSampleApplicationMongoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
